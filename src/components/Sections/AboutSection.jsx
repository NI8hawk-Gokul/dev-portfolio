            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        <motion.div
                            variants={itemVariants}
                            className="text-center pt-0 pb-0 flex flex-col items-center leading-none"
                        >
                            <div
                                className={`text-sm ${
                                    isDarkMode
                            ...
                            <img
                                src={SIGNATURE}
                                alt="Gokul"
                                className="w-44 md:w-56 -my-6"
                            />

                            <div className="text-2xl md:text-3xl font-medium text-blue-500">
                                K Gokul
                            </div>
                        </motion.div>
                    </motion.div>
