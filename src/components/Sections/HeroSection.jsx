          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              <motion.p
                ...
                } mt-8 max-w-xl mx-auto font-light leading-relaxed`}
              >
              ...
              <motion.div
                variants={textVariants}
                className="flex justify-center space-x-6 text-xs uppercase tracking-widest"
              >
                <span
            ...
            >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => ScrollToSection("work")}
                  className="bg-blue-500 hover:bg-blue-600 text-white py-4 px-8 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
                >
                  View Work
                </motion.button>
