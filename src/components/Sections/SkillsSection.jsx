    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className={`absolute -bottom-40 left-1/4 w-96 h-96 rounded-full blur-3xl opacity-5 ${
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        scalable web applications from concept to
                        deployment.
                    </motion.p>
                </motion.div>
                        ...
                        {TECH_STACK.map((tech) => (
                            <motion.span
                                ...
                                className={`px-4 py-2 text-sm rounded-full border transition-all duration-300 ${
                                    isDarkMode
                                        ? "bg-gray-900 border-gray-700 text-gray-300 hover:bg-gray-600"
                                        : "bg-white border-gray-300 text-gray-700 hover:bg-gray-400"
                                }`}
                            >
                                {tech}
                            </motion.span>
                ...
                >
                    {STATS.map((stat) => (
                        ...
                        >
                            <div className="text-3xl md:text-4xl font-bold text-blue-500 mb-3">
                                {stat.number}
                            </div>
